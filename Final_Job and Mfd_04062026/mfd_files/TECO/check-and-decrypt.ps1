...
# ---------- CONFIG ----------
$inDir   = "C:\Users\RPAdmin\Desktop\EDI-ROCKYMOUNTAIN\Incoming\Encrypted-Incoming"
$outDir  = "C:\Users\RPAdmin\Desktop\EDI-ROCKYMOUNTAIN\Incoming\Decrypted-Output"
$passphrase = "B@jyh#?!bzFX8Cmv"          # Your passphrase (protect file permissions)
